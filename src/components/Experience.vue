  ...
  <section id="experience">
    <div class="container">
      ...
      <table class="table table-hover table-striped exptable">
        <caption class="text-center boldextra">Job experience:</caption>
        <thead>
        ...
        <tr>
          ...
          <td class="bold-col">Team Lead (FE team)</td>
        </tr>
        <tr>
      ...
      <table class="table table-hover table-striped exptable">
        ...
        <tr>
          <td>Academind.com</td>
          <td class="bold-col">
        JavaScript Data Structures, JavaScript Algorithms, Docker & Kubernetes: The Practical Guide,
        JavaScript - The Tricky Parts</td>
        </tr>
        <tr>
          <td>Udemy.com</td>
          <td class="bold-col">
